...
const SLASH_COMMANDS: SlashCommand[] = [
	...
	},
	{
		id: "fix",
		label: "fix",
		description: "Recover when model cannot continue",
	...
	},
	{
		id: "info",
		label: "info",
		description: "Show session info and tokens",
	...
	},
	{
		id: "goals",
		label: "goals",
		description: "Open goals overview",
	...
	},
	{
		id: "review",
		label: "review",
		description: "Launch a one-shot review session",
	...
	},
	{
		id: "judge",
		label: "judge",
		description: "Launch a one-shot judge session",
	...
	},
	{
		id: "save",
		label: "save",
		description: "Bookmark session for easy access",
	...
	},
	{
		id: "workspace",
		label: "workspace",
		description: "Manage Niri-style session workspace",
