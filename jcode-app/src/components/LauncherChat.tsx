...
export function LauncherChat({
  ...
  const handleSend = async () => {
    ...
    if (skillMatch) {
      ...
      try {
        const list =
          skills.length > 0 ? skills : await invoke<SkillInfo[]>("list_skills");
        ...
        <div className="flex items-center justify-between px-3 py-2 border-b border-[var(--launcher-glass-border)]">
          <div className="flex items-center gap-2">
            ...
            {hasModelSwitcher ? (
              ...
              >
                <SelectTrigger className="h-5 px-2 border-0 bg-transparent py-0 text-[10px] launcher-muted shadow-none hover:text-foreground focus:ring-0 gap-1 w-fit">
