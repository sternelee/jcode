				...
				<DialogHeader>
					<div className="flex items-center gap-3">
						...
						>
							...
							>
								<path
									d="M8 1a3 3 0 00-3 3v3H4a2 2 0 00-2 2v4a2 2 0 002 2h8a2 2 0 002-2V9a2 2 0 00-2-2h-1V4a3 3 0 00-3-3zM6 7V4a2 2 0 114 0v3H6zm1 3.75a.75.75 0 011.5 0v1.5a.75.75 0 01-1.5 0v-1.5z"
									clipRule="evenodd"
								/>
							</svg>
						</div>
						<div>
							...
							<DialogDescription className="text-[12px] mt-0.5">
								tool: {prompt.toolCallId || "unknown"} · request:{" "}
								{prompt.requestId.slice(0, 8)}
							</DialogDescription>
						</div>
					</div>
				</DialogHeader>
